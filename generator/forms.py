...
class CreateCardForm(ModelForm):
	...
	typeface = TypefaceModelChoiceField(widget=RadioSelect, queryset=Typeface.objects.all(), required=True, empty_label=None)
	border = BorderModelChoiceField(widget=RadioSelect, queryset=Border.objects.all(), required=True, empty_label=None)
